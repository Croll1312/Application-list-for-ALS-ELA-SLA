<body>
   <h1>Lista de aplicaciones para personas con ELA y otros.</h1>
   <ol>
      <li><a href = "https://www.mindmate-app.com/">MindMate:</a></li>
      <p>
         <i>
<p>La aplicación MindMate te ofrece un plan diario de actividades que te ayuda a mantener tu mente y cuerpo en forma. Realiza ejercicios, descubre recetas deliciosas y saludables, juega juegos para mantener tu materia gris activa y aprende en videos y artículos sobre lo que puedes hacer para mantenerte saludable a medida que envejeces.<p>
Basada en ciencia de primer nivel mundial, la aplicación MindMate estimula el cerebro con juegos divertidos e interactivos.<p>Los juegos están diseñados para desafiar las cuatro áreas cognitivas principales: resolución de problemas, velocidad, memoria y atención. Ideal para personas que priorizan un envejecimiento saludable, aquellos que viven con problemas de memoria como el Alzheimer o la demencia, y aquellos con antecedentes familiares de deterioro cognitivo.<p>
Mantén tu forma física con rutinas diarias de ejercicio, consejos nutricionales y recetas saludables.<p>Permítenos personalizar una rutina para tu nivel de fitness y ayudarte a alcanzar una versión más saludable de ti mismo/a. Lleva un registro de tu progreso y metas en la aplicación MindMate.<p>
Comer lo correcto puede marcar una gran diferencia en tu vida. Te contamos todo lo que necesitas saber sobre cómo comer de manera más saludable y te mostramos cómo preparar esas deliciosas comidas.</i>
<p>
      <p><b>***Funciona en Apple/IOS/iPhone y en escritorio/PC.***</b>
      <p>
      ...
      <p>Más detalles en su web oficial: https://www.mindmate-app.com/ </p>
      <br>
...
III. Acceso Rápido a Oraciones Anteriores: La lista de favoritos y la lista reciente ayudan a proporcionar un acceso rápido a las oraciones comúnmente utilizadas o recientes.<p></i>
      <p><b>***Funciona en Apple/IOS/iPhone/iPad.***</b>
      <p>
      ...
      <i>
<p>Eye-D desarrolla soluciones innovadoras para personas ciegas y con discapacidad visual (VI).<p>Estas soluciones actúan como un verdadero compañero, ayudándoles a lograr la independencia en tres áreas principales: aprendizaje, identificación y navegación.<p>
...
<p>Soluciones que no solo les ayudan a realizar las tareas diarias, sino que también hacen que el mundo sea más accesible para ellos.<p>Dos de nuestras soluciones que han creado una nueva era de esperanza son la aplicación Eye-D y las gafas inteligentes Eye-D.<p>
Impulsados por el impacto de nuestras soluciones innovadoras y asequibles, seguimos investigando hacia nuevas soluciones que puedan ayudar a la comunidad de personas ciegas en general.<p></i>
      <p><b>***Funciona en IOS/iPhone/Android.***</b>
      <p>
      ...
      <p>
         <i>
            <p>✔️ BIG Launcher hace que el smartphone sea adecuado para personas mayores, niños y personas con enfermedades o problemas oculares, o con discapacidad visual.<p>
✔️ Los usuarios con discapacidad visual y con dificultades técnicas pueden utilizar una interfaz sencilla y fácil de leer con facilidad.<p>
✔️ No hay miedo de cometer un error y perderlo todo con una navegación sin estrés.<p>
✔️ ¡También cuenta con un botón de SOS que puede salvar vidas!<p>
🔹 Los esquemas de colores de alto contraste y tres tamaños de fuente diferentes te permiten usar el teléfono sin gafas.<p>
🔹 Hay disponibles temas de colores adicionales y paquetes de iconos para descargar.<p>
🔹 El soporte extendido para el lector de pantalla Talkback permite a los usuarios con discapacidad visual utilizar su teléfono con facilidad y confianza.<p>
🔹 Todas las aplicaciones también se pueden controlar mediante un teclado físico o a través de la interfaz de silla de ruedas Tecla, lo que permite a los usuarios con parálisis tener un control completo y preciso del smartphone sin necesidad de tocar la pantalla.<p>
BIG Launcher está disponible en los siguientes idiomas: հայերեն, azərbaycan dili, বাংলা, български, 简体中文, 繁體中文, hrvatski, česky, dansk, nederlands, english, eesti, suomi, français, deutsch, ελληνικά, halshen hausa, हिन्दी, magyar, bahasa indonesia, italiano, 日本語, basa jawa 한국어, kurdî, latviešu, lietuvių, bahasa melayu, norsk, polski, português, português brasileiro, ਪੰਜਾਬੀ, română, русский, српски, srpski, slovenčina, slovenščina, español, svenska, தமிழ், తెలుగు, ภาษาไทย, türkçe, українська мова, tiếng việt, العربية, עברית, فارسی, پنجابی, اردو.<p></i>
      ...
      <p>
         <i>
            Google Talkback es un servicio de accesibilidad para el sistema operativo Android que ayuda a los usuarios ciegos y con discapacidad visual a interactuar con sus dispositivos.<p>
Utiliza palabras habladas, vibraciones y otros comentarios audibles para permitir al usuario saber qué está sucediendo en la pantalla y así poder interactuar mejor con su dispositivo.<p>
Este servicio viene preinstalado en muchos dispositivos Android y se convirtió en parte de la Suite de Accesibilidad de Android en 2017.<p>
Según la tienda de aplicaciones Google Play, la Suite de Accesibilidad de Android ha sido descargada más de cinco mil millones de veces, incluyendo dispositivos que la tienen preinstalada.<p></i>
      <p><b>***Funciona en Android.***</b>
      <p>
      ...
      <p>
      <p>Más detalles en su web oficial: https://support.google.com/accessibility/android/answer/6283677?hl=en </p>
      <p>Cómo configurar y utilizar la aplicación Talkback de Android: https://www.lifewire.com/how-to-use-android-talkback-app-4769904
      </p>
      <br>
      ...
      <p><i>Voice Access ayuda a cualquier persona que tenga dificultad para manejar una pantalla táctil (por ejemplo, debido a parálisis, temblores o lesiones temporales) a utilizar su dispositivo Android mediante voz.</i>
      <p><b>***Funciona en Android.***</b>
      <p>
...
Así nació el proyecto original de un concurso culinario dedicado a alimentos picados y mezclados: Mixiton, el reencuentro con el placer de la mesa.<p></i>
      ...
      <p>
<p><i>CareZone es una aplicación móvil diseñada para ayudar a las personas y a sus cuidadores a gestionar la atención médica y los medicamentos desde una plataforma centralizada.<p>
...
• Apoyar el descubrimiento y el cambio en la práctica.<p>
• Proporcionar contenido médico relevante y específico de enfermedades basado en evidencia.<p>
• Mejorar los resultados del paciente en el punto de atención.<p>
*Características:
• Contenido de esclerosis múltiple actualizado continuamente.<p>
• Temas sobre diagnóstico, tratamiento y manejo del cuidado desarrollados por médicos expertos.<p>
• Estudios de casos, videos y entrevistas.<p>
• Acceso a datos de pacientes grabados que se pueden utilizar para tomar acciones.<p>
• Lista de referencias detallada con acceso a las fuentes originales.<p>
• Crédito de educación médica continua (CME/CE).<p>
• Encuestas y votaciones entre pares.<p>
• Recursos de educación para pacientes para compartir con los pacientes.<p></i>
...
I.Inyecciones, con una selección de posiciones de inyección y notas opcionales.

II.Síntomas, con títulos y notas individuales.
<p>
   - Recordatorios:
<p>
...
<p>
   - Exportar:
<p>
Exporta tus datos en formato PDF o por correo electrónico.<p></i>
  ...
  <p><b>***Funciona en iPhone/iPad.***</b>
      ...
      <li><a href = "https://apps.apple.com/us/app/letmetalk/id919990138">LET ME TALK:</a></li>
         <p>
         <i>
Una aplicación gratuita de comunicación aumentativa y alternativa (AAC) que brinda apoyo en todas las áreas de la vida y, por lo tanto, les da voz a todos.<p> LetMeTalk es financiada mediante donaciones.<p>
LetMeTalk te permite alinear imágenes de manera significativa para leer esta fila de imágenes como una oración.<p> Alinear imágenes se conoce como AAC (Comunicación Aumentativa y Alternativa).<p>
La base de datos de imágenes de LetMeTalk contiene más de 9,000 imágenes de fácil comprensión de ARASAAC (http://arasaac.org). <p>Además, puedes agregar imágenes existentes desde el dispositivo o tomar nuevas fotos con la cámara incorporada.<p>
Para utilizar LetMeTalk no se necesita conexión a internet ni contrato móvil, por lo que puedes usar LetMeTalk en casi cualquier situación, como hospitales, hogares de ancianos o escuelas.<p>
Adecuado para:
...
• compatibilidad con voz para la mayoría de los idiomas.<p></i>
...
• Los pictogramas pueden tener notas "memo".<p></i>
